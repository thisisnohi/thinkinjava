 ...
 * @description <p>Sm4AlgorithmUtil</p>
 * @date 2023/04/06 10:53
 **/
public class Sm4AlgorithmUtil {
    /**
     * 密钥
     */
    public String PASSWORD = "5m28850d763e8748ff2f8d83530e0cf2";

    /**
     * 128-32位16进制;256-64位16进制
     */
//    public final int DEFAULT_KEY_SIZE = 128;
    public final int DEFAULT_KEY_SIZE = 16;

    public final String APPEND_SEPARATOR = "/";

    private final String EN_CODING = "UTF-8";
    ...
    public Sm4AlgorithmUtil(String password) {
     ...
     * @return
     */
    public String encrypt(AlgorithmNameEnums algorithmName, AlgorithmModeEnums algorithmMode, AlgorithmPaddingModeEnums algorithmPadding, String param) throws Exception {
        ...
        try {
            ...
            e.printStackTrace();
            throw new Exception(String.format("加密异常, algorithmName={%s}, algorithmMode={%s} ," + "algorithmPadding={%s} ,param={%s},message={%s}", algorithmName.getName(), algorithmMode.getModeName(), algorithmPadding.name(), param, e.getMessage()));
        }
        return cipherText;
    }
     ...
     * @return
     */
    public String decrypt(AlgorithmNameEnums algorithmName, AlgorithmModeEnums algorithmMode, AlgorithmPaddingModeEnums algorithmPadding, String param) throws Exception {
        if (StringUtils.isNotBlank(param)) {
            try {
                String decryptStr = "";
                byte[] pwdBytes = ByteUtils.fromHexString(PASSWORD);
                ...
                throw new Exception(String.format("解密异常, algorithmName={%s}, algorithmMode={%s} ," + "algorithmPadding={%s} ,param={%s},message={%s}", algorithmName.getName(), algorithmMode.getModeName(), algorithmPadding.name(), param, e.getMessage()));
            }
        } else {
            return param;
        }
     ...
     * @throws Exception
     */
    private Cipher generateCipher(AlgorithmNameEnums algorithmName, AlgorithmModeEnums algorithmMode, AlgorithmPaddingModeEnums algorithmPadding, int cipherMode, byte[] key, byte[] iv) throws Exception {
        String algorithmNameModePadding = algorithmName.getName() + APPEND_SEPARATOR + algorithmMode.getModeName() + APPEND_SEPARATOR + algorithmPadding.getCode();
     ...
     * @throws Exception
     */
    public byte[] generateKey(String algorithmName, int keySize) throws Exception {
